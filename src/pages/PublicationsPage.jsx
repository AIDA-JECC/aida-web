...
export default function PublicationsPage({ onNavigate }) {
  ...
  const handleBack = () => {
    if (window.history.length > 1) {
      ...
      else window.location.hash = '#publications';
    }
  };

  return (
    <div className="min-h-screen bg-[#080808] text-white pt-6 pb-24 px-4 sm:px-6 lg:px-12 font-sans selection:bg-red-600/30">
      ...
      {/* Dedicated Publications View (Lists all records completely, default tab staff) */}
      <PublicationsSection showAll={true} defaultTab="staff" onNavigate={onNavigate} />
    </div>
  );
}
