...
const astraAchievement = {
  ...
  registerNumber: "JEC26AD-ASTRA",
  email: "",
  semester: "Semester 6",
  title: "1st Prize (₹15,000 Cash Prize) – ASTRA State Hackathon",
  description: "Secured 1st Prize along with a ₹15,000 cash prize for developing an outstanding innovative project solution at the ASTRA State Level Hackathon.",
